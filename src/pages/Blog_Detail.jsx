...
export default function Blog_Detail() {
  ...
  const loadRatingBlog = async () => {
    const res = await axios.get(`http://localhost/laravel8/laravel8/public/api/blog/rate/${id}`);
  ...
  const RatingList = Object.entries(listRating);
  const avg =
    RatingList.length > 0
      ? RatingList.reduce((sum, item) => sum + item[1].rate, 0) / RatingList.length
      : 0;
    ...
    <main>
          ...
          <div className="single-blog-post">
            ...
            <div className="post-meta">
              ...
              <span>
                ...
                <RatingProduct id_blog={id} onRated={loadRatingBlog} />
              </span>
            </div>
            <a href="">
              <img
                src={`http://localhost/laravel8/laravel8/public/upload/Blog/image/${blog.image}`}
                alt="blog_image"
              />
            </a>
      ...
      <div className="rating-area">
        <ul className="ratings">
          ...
          {avg === 0 ? 'Chưa đánh giá' : <Rating value={avg} />}
          <li className="color">({RatingList?.length} votes)</li>
        </ul>
        <ul className="tag">
          <li>TAG:</li>
          <li>
          ...
          <div className="col-sm-12">
            ...
            <div className="text-area">
              ...
              <textarea
                ...
                value={textArea}
                className="border_comment"
                name="message"
                rows="11"
              ></textarea>
              <button onClick={handleTextArea} className="btn btn-primary">
                post comment
              </button>
            </div>
          </div>
